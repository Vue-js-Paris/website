...
<template>
  <article>
    <NuxtLink
      ...
      class="flex h-full w-24 flex-col items-center gap-5 rounded-2xl p-2 transition-all hover:scale-110 hover:duration-200 dark:bg-darkerbg sm:w-32 md:w-40 xl:w-60"
    >
      <img
        :src="image"
        :alt="alt"
